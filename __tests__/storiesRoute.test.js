...
test('get all stories', async () => {
  const getAllStories = await supertest(server)
    ...
    .set(
      'Authorization',
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWJqZWN0Ijo3LCJ1c2VybmFtZSI6ImRyYWNvIHRoZSBkcmFnb24yMCIsImlhdCI6MTU5NjIyNzY3MywiZXhwIjoxNTk2MzE0MDczfQ.NAGkBbp30x3b0o4Ha7EcoL3mB71k04aFLFZyqNQ8sww'
    );
